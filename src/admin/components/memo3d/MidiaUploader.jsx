...
// Foto passa pelo Vercel pra aplicar watermark — 4MB é o limite de body do plano Pro.
// Voluson exporta tipicamente <500KB então sobra muito espaço.
    ...
    <div className="midia-uploader">
      ...
      >
        ...
        <p className="muted">
          ...
          <br />
          Fotos (JPEG, PNG, WebP — até 4MB) ou vídeo (MP4, MOV, AVI, WebM — até 100MB)
        </p>
        <input
          ref={fileInputRef}
          type="file"
