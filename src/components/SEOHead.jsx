...
const SEOHead = ({ 
  ...
  const defaultDescription = "Acompanhe as últimas inovações em Inteligência Artificial na medicina brasileira. Notícias, pesquisas e análises especializadas sobre IA médica, startups de saúde e transformação digital hospitalar.";
...
export const SEOPresets = {
  homePage: {
    ...
    description: "Portal especializado em Inteligência Artificial na medicina brasileira. Notícias, análises e inovações em saúde digital, startups médicas e hospitais inteligentes.",
  ...
  articleITMI: {
    ...
    description: "Hospital das Clínicas da USP receberá US$ 320 milhões para criar o primeiro hospital público inteligente do Brasil, reduzindo tempo de espera de 17h para 2h com IA e 5G.",
  ...
  articleVoaHealth: {
    ...
    description: "Startup brasileira recebe US$ 3 milhões da Prosus Ventures e reduz 80% do tempo de documentação médica com IA generativa. 20 mil médicos já utilizam a plataforma.",
    keywords: ["Voa Health", "prontuário eletrônico", "IA generativa", "startup saúde", "Prosus Ventures"]
  }
};
