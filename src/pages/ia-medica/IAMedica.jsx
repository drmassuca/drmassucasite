...
const IAMedica = () => {
  ...
  const articles = [
    ...
    },
    {
      ...
      excerpt: "Ferramenta open source desenvolvida na UFF identifica enfisema e câncer pulmonar em tomografias com alta precisão.",
      category: "Pesquisa",
      date: "2025-07-20",
      readTime: "6 min",
    ...
    },
    {
      ...
      excerpt: "Centro de referência atinge 72% de precisão na prevenção de doença renal contra 22% dos métodos tradicionais.",
    ...
    },
    {
      ...
      excerpt: "Primeira ferramenta mundial de IA generativa para registros de ensaios clínicos reduz aprovação para 48h.",
      category: "Pesquisa",
      date: "2025-03-25",
      readTime: "5 min",
    ...
    },
    {
      ...
      excerpt: "Conselho Federal de Medicina estabelece diretrizes para uso responsável da IA como ferramenta auxiliar.",
    ...
    },
    {
      ...
      excerpt: "Presidência brasileira prioriza cooperação internacional em IA médica e governança de dados em saúde.",
    ...
    },
    {
      ...
      excerpt: "Projeto de Lei busca equilibrar inovação tecnológica com segurança jurídica na aplicação da IA em saúde.",
      category: "Regulamentação",
      date: "2025-08-05",
      readTime: "5 min",
  ...
  return (
    <>
      <SEOHead
        ...
        keywords={["IA médica", "hospitais inteligentes", "startups saúde", "pesquisa médica", "regulamentação IA"]}
          ...
          <div className="hero-content">
            <div className="hero-text">
              <h1>
                ...
                <br />na Medicina Brasileira
              </h1>
              <p className="hero-description">
                Acompanhe as últimas inovações, pesquisas e aplicações da IA 
                transformando a saúde no Brasil. Notícias atualizadas e análises 
                especializadas para profissionais da área médica.
              </p>
          ...
          <div className="featured-grid">
            {featuredArticles.map((article) => (
              <article 
                ...
                onClick={() => navigate(`/ia-medica/artigo/${article.id}`)}
                style={{ 
                  cursor: 'pointer',
