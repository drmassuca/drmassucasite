        ...
        <VStack spacing={4}>
          ...
          {showFullDescription && (
            <Text color="gray.600" textAlign="center" maxW="500px">
              Assista ao tutorial completo de configuração e veja como otimizar o Stable Diffusion
              para gerar as melhores imagens fetais.
            </Text>
          )}
        </VStack>
      </CardBody>
      ...
      <VStack spacing={8} align="stretch">
        ...
        <Alert status="success">
          ...
          <VStack align="start" spacing={1} flex="1">
            ...
            <Text fontSize="sm">
              Esta configuração foi validada em 3 casos reais com qualidade ⭐⭐⭐⭐⭐ em todos os
              aspectos: preservação anatômica, naturalidade e utilidade clínica.
            </Text>
          </VStack>
        </Alert>
                ...
                <Table variant="simple">
                  ...
                  <Tbody>
                    <Tr>
                      ...
                      <Td>
                        <Code>realisticVisionV51_v51VAE.safetensors</Code>
                      </Td>
                      <Td>
                    ...
                    <Tr>
                      ...
                      <Td>
                        <Badge colorScheme="orange">Importante</Badge>
                      </Td>
                    </Tr>
                    <Tr>
          ...
          <CardBody>
            <VStack spacing={6} align="stretch">
              <Alert status="info">
                <AlertIcon />
                <Text fontSize="sm">
                  O segredo da qualidade está na combinação de dois ControlNets de profundidade com
                  pesos e modos diferentes para controle otimizado.
                </Text>
              </Alert>
              ...
              <Grid templateColumns={{ base: '1fr', md: 'repeat(2, 1fr)' }} gap={6}>
                <Card variant="outline">
                  ...
                  <CardBody pt={2}>
                    <VStack align="start" spacing={2}>
                      <Text>
                        <strong>Preprocessor:</strong> <Code>depth_zoe</Code>
                      </Text>
                      <Text>
                        <strong>Model:</strong> <Code>control_v11f1p_sd15_depth</Code>
                      </Text>
                      <Text>
                        <strong>Weight:</strong> <Code>0.6</Code>
                      </Text>
                      <Text>
                        <strong>Control Mode:</strong> <Code>ControlNet is more important</Code>
                      </Text>
                      <Text>
                        <strong>Resize Mode:</strong> <Code>Crop and Resize</Code>
                      </Text>
                    </VStack>
                  </CardBody>
                </Card>
                ...
                <Card variant="outline">
                  ...
                  <CardBody pt={2}>
                    <VStack align="start" spacing={2}>
                      <Text>
                        <strong>Preprocessor:</strong> <Code>depth_midas</Code>
                      </Text>
                      <Text>
                        <strong>Model:</strong> <Code>control_v11f1p_sd15_depth</Code>
                      </Text>
                      <Text>
                        <strong>Weight:</strong> <Code>1.0</Code>
                      </Text>
                      <Text>
                        <strong>Control Mode:</strong> <Code>Balanced</Code>
                      </Text>
                      <Text>
                        <strong>Resize Mode:</strong> <Code>Crop and Resize</Code>
                      </Text>
            ...
            <VStack spacing={6} align="stretch">
              ...
              <Box>
                <Text fontWeight="semibold" mb={2} color="red.600">
                  ❌ Prompt Negativo (Copie exatamente)
                </Text>
                <Code display="block" p={4} bg="red.50" borderRadius="md" whiteSpace="pre-wrap">
                  cartoon, anime, cgi, doll, plastic skin, wax, lowres, blurry, distorted, deformed,
                  uncanny, hair, lines
                </Code>
              </Box>
            </VStack>
                ...
                <Table variant="simple" size="sm">
                  <Tbody>
                    ...
                    <Tr>
                      ...
                      <Td>
                        <Code>None</Code> (usa o próprio modelo SD)
                      </Td>
                    </Tr>
                    <Tr>
            ...
            <OrderedList spacing={4}>
              <ListItem>
                <VStack align="start" spacing={2}>
                  ...
                  <UnorderedList spacing={1} pl={4}>
                    <ListItem>
                      Use a ferramenta de recorte do Windows para remover o HUD do aparelho
                    </ListItem>
              ...
              <ListItem>
                <VStack align="start" spacing={2}>
                  ...
                  <UnorderedList spacing={1} pl={4}>
                    <ListItem>
                      Vá para a aba <Code>img2img</Code>
                    </ListItem>
                    <ListItem>Carregue sua imagem</ListItem>
                    <ListItem>
                      Selecione o modelo <Code>realisticVisionV51_v51VAE</Code>
                    </ListItem>
              ...
              <ListItem>
                <VStack align="start" spacing={2}>
                  ...
                  <UnorderedList spacing={1} pl={4}>
                    <ListItem>
                      Clique em <Code>Generate</Code> para criar a versão 512x512
                    </ListItem>
